...
public class ValidationErrorResult
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ValidationErrorResult"/>
    /// class using the specified <paramref name="failure"/>.
    /// </summary>
    /// <param name="failure">The validation error that occurred.</param>
    public ValidationErrorResult(FluentValidationFailure failure)
    {
    ...
    /// <summary>
    /// Gets the <see cref="FluentValidationFailure"/> object.
    /// </summary>
    public FluentValidationFailure? Failure { get; }
