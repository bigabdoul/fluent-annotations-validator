...
public class WhenOtherwiseRuleTests
{
    ...
    private ValidationTypeConfigurator<ConditionalTestDto> _configurator;
    ...
    public WhenOtherwiseRuleTests()
    {
        ...
        {
            ConfigureValidationConfigurator = config => _configurator = config.For<ConditionalTestDto>(),
    ...
    public async Task Given_WhenAsyncConditionIsTrue_Then_OtherwiseAsyncRulesShouldNotRun()
    {
        ...
        _configurator.RuleFor(x => x.Name)
            ...
            (
                ...
                rule => 
                rule.MustAsync(AlwaysFailAsync).WithMessage("WhenAsync rule ran but failed.")
            )
            .OtherwiseAsync(rule =>
            {
